...
public:
  ...
  void Run(const int steps, const T *W, const T *R, const T *bx, const T *br,
           const T *x, T *h, T *v, T *act_Wx,
           layer_norm::ForwardPass<T> &layer_norm1, T *tmp_Wx_norm, T *act_Rh,
...
private:
  void IterateInternal(const T *R, const T *bx, const T *br, const T *h,
                       T *h_out, T *v, T *tmp_Wx_norm, T *act_Rh,
                       layer_norm::ForwardPass<T> &layer_norm2, T *tmp_Rh_norm,
                       const float zoneout_prob, const T *zoneout_mask);
...
public:
  ...
  void Run(const int steps, const T *W_t, const T *R_t, const T *bx,
           ...
           layer_norm::BackwardPass<T> &layer_norm2, const T *zoneout_mask);
