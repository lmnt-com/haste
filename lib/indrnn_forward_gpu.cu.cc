...
__global__ void IndrnnFwdOps(const int steps, const int batch_size,
                             const int hidden_size, const T *Wx, const T *u,
                             const T *b, const T *h, T *h_out,
...
void ForwardPass<T>::Run(const int steps, const T *W, const T *u, const T *b,
  ...
  blas<T>::gemm(blas_handle, CUBLAS_OP_N, CUBLAS_OP_N, hidden_size,
                ...
                input_size, &beta, workspace, hidden_size);
