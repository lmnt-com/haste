...
Tensor indrnn_forward(bool training, float zoneout_prob, Tensor x, Tensor h0,
                      Tensor kernel, Tensor recurrent_scale, Tensor bias,
                      Tensor zoneout_mask) {
...
std::vector<Tensor> indrnn_backward(Tensor x_t, Tensor kernel_t,
                                    Tensor recurrent_scale, Tensor bias,
                                    Tensor zoneout_mask, Tensor h,
                                    Tensor dh_new) {
  ...
  AT_DISPATCH_FLOATING_TYPES(
      x_t.scalar_type(), "indrnn_backward", ([&] {
